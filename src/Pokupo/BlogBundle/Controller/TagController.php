...
class TagController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $tag = $this->getDoctrine()->getManager()
                        ->getRepository('PokupoBlogBundle:Tag')->getOneBySlug($request->get('slug', false));
        if (!$tag) {
        ...
        $query = $this->getDoctrine()->getManager()
                        ->getRepository('PokupoBlogBundle:Post')->getQueryForGetByTag($tag);
    ...
    public function allAction(Request $request)
    {
        ...
        $query = $this->getDoctrine()->getManager()
                        ->getRepository('PokupoBlogBundle:Tag')->getQueryForGet();
